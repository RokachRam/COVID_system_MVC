...
class Test:
    class_counter = 0
    def __init__(self, person:Person, lab:Laboratory, test_date:datetime.date, result_date:datetime.date=None, test_result:bool=None):
        self.testId = Test.class_counter
